...
const Header = () => {
  ...
  return (
    <div className='header bg-[#FF714C] flex justify-between items-center p-4'>
        ...
        <button className='hidden md:block lg:block bg-[#ffea2df6] text-black font-["Segoe UI", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif] hover:bg-[#ccbc31f6] font-bold px-4 py-2 rounded-3xl cursor-pointer'>
